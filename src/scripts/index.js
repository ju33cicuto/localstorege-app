...
const createCard = (product) => {
  ...
  btnAddCart.addEventListener("click", () => {
    cartProducts.push(product); //aqui adicionamos o produyo no carrinho utilizando metodo push
...
const renderCards = (array) => {
  ...
  productsList.innerHTML = "";// por boa praticass sempre limpar o html antes de renderizar o conteúdo
...
const renderCartCards = (array) => {// essa função sempre tem que zsser chamada dentro do eveento de adicionar o carrinho
  const cartList = document.querySelector(".cart__list");

  cartList.innerHTML = "";//por boa praticass sempre limpar o html antes de renderizar o conteúdo
